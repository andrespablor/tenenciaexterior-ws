...
function saveCurrentWatchlist() {
    ...
    if (newName !== oldName) {
        ...
        // CRITICAL FIX: Deep copy the entire watchlist data structure
        // This preserves whether it's an array or object format
        watchlists[newName] = JSON.parse(JSON.stringify(watchlists[oldName]));
