...
function initializeTabs() {
    document.querySelectorAll('.tab').forEach(tab => {
        tab.addEventListener('click', () => {
            ...
            // IMPORTANTE: Asegurar que Argentina nunca se active en Comitente
            const argentinaSection = document.getElementById('argentina');
            if (argentinaSection && window.currentModule === 'comitente') {
                argentinaSection.classList.remove('active');
                argentinaSection.style.setProperty('display', 'none', 'important');
            }
